...
patients_cov = patients_cov.drop(['subjectID', args.sex_column, 'site_ID_bin', 'site_ADNI3_GE36', 'site_ADNI3_GE54', 'site_ADNI3_P33', 'site_ADNI3_P36', 'site_ADNI3_S127', 'site_ADNI3_S31', 'site_ADNI3_S55', 'site_OASIS3'], axis=1)
