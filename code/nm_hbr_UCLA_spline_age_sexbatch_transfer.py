...
# 20 ROIS + Average WM = 21 total rois. Removed the CST. Bilateral, not left and right.
rois =['ACR','ALIC','Average','BCC','CGC','CGH', 'EC','FX','FXST','GCC',
...
X_train_f1 = X_train_f1.drop(['subjectID', args.sex_column, 'site_ID_bin', 'site_UCLA_0', 'site_UCLA_1'], axis=1)
...
UCLA_0_te = X_test_f1.index[X_test_f1['site_UCLA_0'] == 1].to_list()
UCLA_1_te = X_test_f1.index[X_test_f1['site_UCLA_1'] == 1].to_list()
...
X_test_f1 = X_test_f1.drop(['subjectID', args.sex_column, 'site_ID_bin', 'site_UCLA_0', 'site_UCLA_1'], axis=1)
