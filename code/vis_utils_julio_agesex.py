...
@author: Julio Villalón. Modified from Seyed Mostafa Kia @seykia. 
"""
...
def plot_normative_models_multi(processing_dir, num_sites, site_id, area_id, metric, age_min, age_max, sex_batch):
   ...
   # This is opening the dummy X_test and the dummy batch files
    ...
    return X_dummy, batch_effects_dummy, yhat_dummy_bothsex, ys2_dummy_bothsex, yhat_women, ys2_women, yhat_men, ys2_men
